...
# --- IMPORTS ---
sys.path.append(os.path.join(os.path.dirname(__file__), '..'))   # distillation_b_wt/ for HA.*
...
def main():
    ...
    if is_master:
        ...
        print(f"LR: {learning_rate:.2e} (base {cfg.base_lr:.2e} × {world_size}) | Grad clip: {cfg.grad_clip_norm}")
