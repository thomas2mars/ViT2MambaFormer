...
from utils.vit_utils import ViTStatesExtractor
from utils.data import build_val_dataloader
from MambaFormer.MambaFormer import MambaFormer_Large_expand1_light_BiMamba2
...
def load_models(cfg, checkpoint_path, device):
    ...
    # Student
    student = MambaFormer_Large_expand1_light_BiMamba2(double_cls_token=cfg.double_cls_token)
...
def main():
    ...
    parser.add_argument('--checkpoint', type=str, required=True,
                        help='Path to checkpoint file (e.g. logs/distill_MO_v1/checkpoint_latest.pt)')
