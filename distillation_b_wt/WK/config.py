"""WK Base v1 — Same recipe as Large WK v3, adapted for ViT-B/16 teacher.
...
class DistillationConfig:
    ...
    # Paths
    root_dir: str = "distillation_b_wt/WK/logs/distill_WK_base_v1"
    teacher_weights_path: str = "models/vit/ViT-B_16.npz"
    step2_checkpoint_path: str = "distillation_b_wt/HA/logs/distill_HA_base_v1/checkpoint_latest.pt"
