#!/bin/bash
#SBATCH --job-name=distill_MO_base_mambaformer
...
#SBATCH --output=distillation_b_wt/MO/logs/%x_%j.out
#SBATCH --error=distillation_b_wt/MO/logs/%x_%j.err
...
mkdir -p distillation_b_wt/MO/logs
