#!/bin/bash
#SBATCH --job-name=distill_HA_base_mambaformer
...
#SBATCH --output=distillation_b_wt/HA/logs/%x_%j.out
#SBATCH --error=distillation_b_wt/HA/logs/%x_%j.err
...
mkdir -p distillation_b_wt/HA/logs
