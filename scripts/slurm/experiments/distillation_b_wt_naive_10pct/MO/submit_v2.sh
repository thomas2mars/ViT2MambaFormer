#!/bin/bash
#SBATCH --job-name=distill_MO_base_naive_10pct_v2
...
cp distillation_b_wt_naive_10pct/MO/config.py distillation_b_wt_naive_10pct/MO/config.py.bak
cp distillation_b_wt_naive_10pct/MO/config_v2.py distillation_b_wt_naive_10pct/MO/config.py
...
mv distillation_b_wt_naive_10pct/MO/config.py.bak distillation_b_wt_naive_10pct/MO/config.py
