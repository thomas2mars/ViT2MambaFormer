#!/bin/bash
#SBATCH --job-name=distill_HA_base_naive_10pct_v2
...
cp distillation_b_wt_naive_10pct/HA/config.py distillation_b_wt_naive_10pct/HA/config.py.bak
cp distillation_b_wt_naive_10pct/HA/config_v2.py distillation_b_wt_naive_10pct/HA/config.py
...
mv distillation_b_wt_naive_10pct/HA/config.py.bak distillation_b_wt_naive_10pct/HA/config.py
